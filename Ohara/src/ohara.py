...
rootDir = '../bib'
#%%
def add_entry_from_file(fname, parent_page):
    entry_row = parent_page.collection.add_row()
...
if __name__ == '__main__':
    ...
    parent_page_url_or_id = "https://www.notion.so/explever/b999c9e3f31d4d7ea14e223615146901?v=0ff45635a2e744c494e57c118a115f88"
    parent_page = client.get_collection_view(parent_page_url_or_id)
    schema_props = parent_page.collection.get_schema_properties()
    # print(schema_props)
    for dirName, subdirList, fileList in os.walk(rootDir):
        # print('Found directory: %s' % dirName)
        for fname in fileList:
            fpath = dirName+"/"+fname
            add_entry_from_file(fpath, parent_page)
    print("Done!")