...
def results(request, question_id):
    question = get_object_or_404(Question, pk=question_id)
    return render(request, 'uploader/results.html', {'question': question})
...
def vote(request, question_id):
    ...
    try:
        ...
        return render(request, 'uploader/detail.html', {
            'question': question,
        ...
        return HttpResponseRedirect(reverse('uploader:results', args=(question.id,)))